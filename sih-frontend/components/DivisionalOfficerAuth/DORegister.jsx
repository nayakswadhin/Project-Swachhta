...
const DORegister = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post('http://localhost:3000/do/register', formData);
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            {/* Basic Information */}
            <div>
              <label htmlFor="doCode" className="block text-sm font-medium text-gray-700">
                DO Code
              </label>
              <input
                type="text"
            ...
            <div className="space-y-4">
              ...
              <div>
                <label htmlFor="officerInCharge.name" className="block text-sm font-medium text-gray-700">
                  Officer Name
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="officerInCharge.email" className="block text-sm font-medium text-gray-700">
                  Officer Email
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="officerInCharge.phone" className="block text-sm font-medium text-gray-700">
                  Officer Phone
                </label>
                <input
                  type="tel"
              ...
              <div>
                <label htmlFor="officerInCharge.password" className="block text-sm font-medium text-gray-700">
                  Password
                </label>
                <input
                  type="password"
